...
class InstructorScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.logs_label = Label(text='', size_hint=(1, None))
        self.logs_label.bind(size=self.adjust_label_text_size)
    ...
    def adjust_label_text_size(self, instance, value):
        # This method adjusts the text_size of the label to match its size
        self.logs_label.text_size = (self.logs_label.width, None)
